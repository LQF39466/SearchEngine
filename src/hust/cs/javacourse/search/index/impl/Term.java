...
public class Term extends AbstractTerm implements FileSerializable {
    /**
     * 缺省构造函数
     */
    public Term() {
    ...
    public boolean equals(Object obj)
        ...
        else throw new IllegalArgumentException("Not Term Object");
    }
    ...
    public int compareTo(AbstractTerm o) {
        return this.content.compareToIgnoreCase(((Term) o).content);
    }
